...
- The current German hero (`public/de-v2/steven-hero-v2.png`) and process photo (`public/de-v2/steven-laptop-v2.png`) are supplied original PNGs; retain them without optimization per user request. Keep the hero photo's embedded text visible, with the full image above the page copy on mobile. The process and Estonia photos use matching responsive widths capped at 440px and a portrait 4:5 ratio. The Estonia section uses the supplied `public/de-v2/estonia-bog.jpeg` without a text overlay. Team portraits and Peter share a responsive 150–250px width and 4:5 aspect ratio.
