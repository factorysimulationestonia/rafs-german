...
- The German landing-page contact area and every German footer show the DACH contact from the centralized `dachContact` object in `src/main.jsx`. Its current portrait, name, role, phone, and email are placeholders and must be replaced together once the responsible person is confirmed.
