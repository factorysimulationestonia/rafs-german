...
- The German landing-page contact area and every German footer show the DACH contact from the centralized `dachContact` object in `src/main.jsx`. Peter J. Fischer is the confirmed DACH contact; only his portrait remains a placeholder until a suitable portrait asset is supplied.
- The German team includes Triinu Strandberg as `Vertrags- und Dokumentenmanagerin`; her portrait is intentionally a placeholder until an approved image is supplied. She is not currently listed on the ET/EN site.
